...
liegt nach Ansicht aller Autoren in (\ref{ex:3-9a}) \isi{normale Betonung} und normale
...
stilistisch \isi{normale Betonung}, wenn S\sub{\textit{i}} stilistisch normale
\isi{Betonung} hat.)
...
ist im Unterschied zu (\ref{ex:3-81a}) nach (\ref{ex:3-79}) \isi{normalbetont}, entgegen der
Aussage von Bartsch.
...
Griesbachs Annahme, in Fällen wie (\ref{ex:3-98}) liege nicht"=\isi{normale Betonung}
...
\isi{Wortfolge} mehr Foki hat) eine entschieden nicht-\isi{normale Betonung},
...
\label{ex:3-115c}
bei \isi{Betonung des Verbs} in S\sub{\textit{j}} eine \isi{Fokusprojektion} von Fk\sub{1} (S\sub{\textit{j}})
...
\end{xlist}
\end{exe}
Umgekehrt ist bei der \isi{Betonung des Verbs} in (\ref{ex:3-118a}) bzw.\ bei \isi{Betonung}
...
\end{exe}
Erläuterung: In wievielen Kontexttypen ein Satz vorkommen kann, hängt davon ab, wieviele Foki er hat. Ein Satz hat, bei gegebener \isi{Wortstellung} (\dash in EB\sub{\textit{i}}), \isi{normale Betonung}, wenn er unter allen Sätzen in EB\sub{\textit{i}} die meisten Foki hat. Um zu prüfen, ob ein Satz S\sub{\textit{i}} normale \isi{Wortstellung} hat, muß man also feststellen: (1) welche S\sub{\textit{j}} in der EB\sub{\textit{i}}, zu der S\sub{\textit{i}} gehört, \isi{normalbetont} sind, (2) ob eine andere \isi{Konstituentenfolge} unter \isi{Normalbetonung} mehr mögliche Foki als S\sub{\textit{j}} zuläßt. Ist dies nicht der Fall, hat S\sub{\textit{i}} nach (\ref{ex:3-147}) eine stilistisch normale \isi{Wortstellung}.
...
umgekehrt ist. (Wir erinnern uns, daß nach (\ref{ex:3-147}) und (\ref{ex:3-79}) sowohl (\ref{ex:3-176a}) als auch (\ref{ex:3-176b}) stilistisch normale \isi{Wortstellung} haben; (\ref{ex:3-176a}) hat stilistisch normale, (\ref{ex:3-176b}) stilistisch nicht"=\isi{normale Betonung}.)
...
S\sub{\textit{i}} hat stilistisch \isi{normale Betonung} gdw.\ er unter allen Sätzen,
